        ...
        <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8 bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
                <div className="text-center">
                    <Icon icon="solar:user-bold" className="mx-auto h-12 w-12 text-blue-600" />
                    <h2 className="mt-6 text-3xl font-black text-slate-900 dark:text-white">
                        로그인
                    </h2>
                    <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                        TACTICAL SHOP에 오신 것을 환영합니다.
                    </p>
                </div>
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="space-y-4 rounded-md shadow-sm">
                        ...
                        <div>
                            <label className="text-sm font-bold text-slate-700 dark:text-slate-300">비밀번호</label>
                            <input
                                name="password"
                                type="password"
                                required
                ...
                <div className="text-center mt-4">
                    <span className="text-sm text-slate-600 dark:text-slate-400">계정이 없으신가요? </span>
                    <Link href="/signup" className="text-sm font-bold text-blue-600 hover:text-blue-500">
                        회원가입
                    </Link>
                </div>
            </div>
