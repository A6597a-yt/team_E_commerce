                        ...
                        <div className="flex items-center gap-1 md:gap-3 ml-2 border-l border-slate-200 dark:border-slate-800 pl-4">
                            ...
                            {isLoggedIn ? (
                                <button
                                    ...
                                    className="flex items-center gap-1 text-sm font-bold text-slate-700 dark:text-slate-300 hover:text-red-600 transition-colors"
                                >
                                    <Icon icon="solar:logout-linear" width={24} className="md:hidden" />
